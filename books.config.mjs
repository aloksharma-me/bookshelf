// Curated catalogue. `src` is relative to ./Books.
// For chapter folders, `src` is the book's index/MOC file: any line that is just a
// [[link]] or ![[embed]] to a sibling file gets replaced with that file's highlights.
// `keyIdeas` (optional) points at a file whose [[links]] are the book's key ideas.
...
export const books = [
  ...
  { title: 'Build', subtitle: 'An Unorthodox Guide to Making Things Worth Making', author: 'Tony Fadell', category: 'work',
    src: 'Build/00 Build – MOC.md', keyIdeas: 'Build/Key Ideas – Build by Tony Fadell.md' },
  ...
  { title: 'Creative Selection', subtitle: 'Inside Apple’s Design Process During the Golden Age of Steve Jobs', author: 'Ken Kocienda', category: 'stories',
    src: 'Creative Selection/Creative Selection – by Ken Kocienda.md', keyIdeas: 'Creative Selection/Key Ideas.md' },
  ...
  { title: 'Deep Work', subtitle: 'Rules for Focused Success in a Distracted World', author: 'Cal Newport', category: 'mind',
    src: 'Deep Work/Deep Work – Rules for Focused Success in a Distracted World – Cal Newport.md' },
  ...
  { title: 'Design Your Thinking', subtitle: 'The Mindsets, Toolsets and Skill Sets for Creative Problem-solving', author: 'Pavan Soni', category: 'design',
    src: 'Design Your Thinking/Design Your Thinking by Pavan Soni.md' },
  ...
  { title: 'The Making of a Manager', subtitle: 'What to Do When Everyone Looks to You', author: 'Julie Zhuo', category: 'work', src: 'Making of a Manager/01. Making of a Manager by Julie Zhuo.md' },
  ...
  { title: 'Project Hail Mary', author: 'Andy Weir', category: 'stories', src: 'Project Hail Mary/00 Project Hail Mary by Andy Weir.md' },
  { title: 'The Psychology of Money', subtitle: 'Timeless Lessons on Wealth, Greed, and Happiness', author: 'Morgan Housel', category: 'money', src: 'The Psychology of Money/The Psychology of Money – Morgan Housel.md' },
